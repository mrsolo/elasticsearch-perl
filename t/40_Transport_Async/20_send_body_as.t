...
my $t = Elasticsearch::Async->new( send_get_body_as => 'GET' )->transport;
...
$t = Elasticsearch::Async->new( send_get_body_as => 'POST' )->transport;
...
$t = Elasticsearch::Async->new( send_get_body_as => 'source' )->transport;
